...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StatementTapFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC21StatementTapFramework12BalanceTapSF")
@interface BalanceTapSF : NSObject <SFSafariViewControllerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21StatementTapFramework19BalanceTapStagingSF")
@interface BalanceTapStagingSF : BalanceTapSF
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC21StatementTapFramework28BalanceWebViewViewController")
@interface BalanceWebViewViewController : UIViewController <WKNavigationDelegate>
- (void)loadView;
- (void)viewDidLoad;
- (void)popScreen;
...
SWIFT_CLASS("_TtC21StatementTapFramework14StatementTapSF")
@interface StatementTapSF : NSObject <SFSafariViewControllerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface StatementTapSF (SWIFT_EXTENSION(StatementTapFramework)) <UIDocumentPickerDelegate>
...
@interface StatementWebViewViewController : UIViewController <WKNavigationDelegate, WKUIDelegate>
